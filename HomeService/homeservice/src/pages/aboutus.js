const AboutUs = () => {
  return (
    ...
    <p style ={{marginTop : 30,fontWeight:600,fontFamily:'serif', fontSize:26,fontStyle:'italic',color : 'dimgrey'}}>
                We are India's one of the leading Online Home Services providers. The company was launched in 2023
    ...
    <img src="https://thumbs.dreamstime.com/b/home-service-repair-construction-fix-house-background-home-service-repair-construction-fix-house-background-155882678.jpg"
           alt= "image"
